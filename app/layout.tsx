  ...
  return (
    <html lang="nl">
      <body className="min-h-screen bg-cream font-brogi" suppressHydrationWarning>
        <header className="bg-darkSlate text-cream px-6 py-4 flex items-center justify-between shadow-md">
        ...
        <footer className="mt-16 py-6 text-center text-sm text-midGreen border-t border-lightBg">
